...
output_experiment_1_dir = output_dir + "Experiment_1/"
output_experiment_1_training_dir = output_experiment_1_dir + "Training/"
output_experiment_1_test_dir = output_experiment_1_dir + "Test/"

output_experiment_2_dir = output_dir + "Experiment_2/"
output_experiment_2_training_dir = output_experiment_2_dir + "Training/"
output_experiment_2_validation_dir = output_experiment_2_dir + "Validation/"
output_experiment_2_test_dir = output_experiment_2_dir + "Test/"
output_experiment_2_test_clash_royale_dir = output_experiment_2_test_dir + "ClashRoyale/"
output_experiment_2_test_rocket_league_dir = output_experiment_2_test_dir + "RocketLeague/"
...
def save_game_sessions(game_sessions):
	...
	test_users_exp_1 = ["192.168.0.13", "192.168.0.25", "192.168.0.29", "192.168.0.33", "192.168.0.44", "192.168.0.48", "192.168.0.51"]
	
	validation_users_exp_2 = ["192.168.0.13", "192.168.0.25", "192.168.0.29"]
	test_users_exp_2_clash_royale = ["192.168.0.33", "192.168.0.44", "192.168.0.48", "192.168.0.51"]
	test_users_exp_2_rocket_league = ["192.168.0.5", "192.168.0.39", "192.168.0.42", "192.168.0.50"]

	for user in training_users:
		if not os.path.exists(output_experiment_1_training_dir + user):
			os.mkdir(output_experiment_1_training_dir + user)
		if not os.path.exists(output_experiment_2_training_dir + user):
			os.mkdir(output_experiment_2_training_dir + user)
		for state in game_sessions[user]:
			xes_exporter.apply(game_sessions[user][state], output_experiment_1_training_dir + user + "/" + state + ".xes")
			xes_exporter.apply(game_sessions[user][state], output_experiment_2_training_dir + user + "/" + state + ".xes")
		
	for user in test_users_exp_1:
		if not os.path.exists(output_experiment_1_test_dir + user):
			os.mkdir(output_experiment_1_test_dir + user)
		for state in game_sessions[user]:
			xes_exporter.apply(game_sessions[user][state], output_experiment_1_test_dir + user + "/" + state + ".xes")
			
	for user in validation_users_exp_2:
		if not os.path.exists(output_experiment_2_validation_dir + user):
			os.mkdir(output_experiment_2_validation_dir + user)
		for state in game_sessions[user]:
			xes_exporter.apply(game_sessions[user][state], output_experiment_2_validation_dir + user + "/" + state + ".xes")

	for user in test_users_exp_2_clash_royale:
		if not os.path.exists(output_experiment_2_test_clash_royale_dir + user):
			os.mkdir(output_experiment_2_test_clash_royale_dir + user)
		for state in game_sessions[user]:
			xes_exporter.apply(game_sessions[user][state], output_experiment_2_test_clash_royale_dir + user + "/" + state + ".xes")

	for user in test_users_exp_2_rocket_league:
		if not os.path.exists(output_experiment_2_test_rocket_league_dir + user):
			os.mkdir(output_experiment_2_test_rocket_league_dir + user)
		for state in game_sessions[user]:
			xes_exporter.apply(game_sessions[user][state], output_experiment_2_test_rocket_league_dir + user + "/" + state + ".xes")					
...
game_sessions = feature_extraction(game_sessions, fe_window_size)
